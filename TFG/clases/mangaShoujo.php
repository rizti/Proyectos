...
require_once "BBDD.php";
 ...
 public function mostShoujo(){
    ...
    <?php
        ...
        $result = $bd->consultarBD("SELECT titulo,Imagen,Estilo,genero_Primario FROM mangainfo WHERE genero_Primario='SHOUJO'");
        for($i=0;$i<=11;$i++){
            $manga = $result->fetch_assoc();
                ...
                <a href="manga.php?titulo=<?php echo $manga['titulo']; ?>"><div class="imagenCaratula">  <img width="230px" height="350px" src="data:image/jpeg;base64,<?php echo($manga['Imagen'])?>"></a>
                    <div class="tituloShoujo" id="indexTituloShoujo"> <?php echo $manga['titulo']; ?> </div>
                </div>
                </div>
            <?php
        }
