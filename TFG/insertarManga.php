...
<div class="row justify-content-md-center" id="contenedorInsertarManga">
    <div class="col-md-8">
        <div class="card2">
            <div class="card-body">
            <h1 class="text-center">INSERTAR MANGA</h1>
                <form name="insertarManga" id="insertarManga" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label text-lg-right">Imagen</label>
                        <div class="col-lg-6">
                ...
                <div class="col-xs-12 col-md-8 offset-md-2">
                    <form action="insertarManga.php">
                        <button type="submit" name="recargar" id="recargar" class="btn btn-block btn-lg btn-danger" >Resetear</button>
                    </form>
            </div>
        </div>
    </div>
...
<script src="./js/insertarManga.js"></script>
